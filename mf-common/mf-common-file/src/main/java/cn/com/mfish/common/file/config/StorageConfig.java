...
import cn.com.mfish.common.file.handler.*;
    ...
    public Storage getStorage() {
        switch (StorageType.getStorageType(storageProperties.getActive())) {
            case Minio:
                ...
                return new MinioStorage(storageProperties.getAddress())
                        .setAccessKey(minio.getAccessKey())
                        .setSecretKey(minio.getSecretKey())
                        .setBucket(minio.getBucket())
