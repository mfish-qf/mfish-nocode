...
public class PhoneSmsAuthenticationProvider implements AuthenticationProvider {
     ...
     * @param loginVerifyService 登录验证服务
     * @param ssoTenantService   租户服务
     */
    @Autowired
    public PhoneSmsAuthenticationProvider(SsoUserService ssoUserService, LoginVerifyService loginVerifyService,
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        String code = loginVerifyService.getSmsCode(user.getPhone());
        ...
        loginVerifyService.retryLimit(user.getId(), matches);

        if (isNew) {
            ssoTenantService.createTenantUser(user);
        }
        if (matches) {
            loginVerifyService.delSmsCode(username);
        }
