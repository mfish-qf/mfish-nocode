...
-- ----------------------------
INSERT INTO `config_info` VALUES (1, 'application-dev.yml', 'DEFAULT_GROUP', 'spring:\n  autoconfigure:\n    exclude: com.alibaba.druid.spring.boot.autoconfigure.DruidDataSourceAutoConfigure\n  redis:\n    host: localhost\n    port: 6379\n    password: 1qaz@WSX\n    database: 5\n# feign 配置\nfeign:\n  sentinel:\n    enabled: true\n  okhttp:\n    enabled: true\n  httpclient:\n    enabled: false\n  client:\n    config:\n      default:\n        connectTimeout: 10000\n        readTimeout: 10000\n  compression:\n    request:\n      enabled: false\n    response:\n      enabled: false\n\n# 暴露监控端点\nmanagement:\n  endpoints:\n    web:\n      exposure:\n        include: \'*\'\nlogging:\n  config: classpath:logback-logstash.xml\nlog:\n  level: info\n  maxSize: 30MB\n# 临时缓存存储时间（单位：天）\ncache:\n  temp:\n    time: 7', '969c62323edc7af00e7d14fcd9b93209', '2023-01-11 12:10:11', '2023-01-15 07:20:56', 'nacos', '0:0:0:0:0:0:0:1', '', '', '', '', '', 'yaml', '', '');
INSERT INTO `config_info` VALUES (2, 'mf-gateway-dev.yml', 'DEFAULT_GROUP', 'spring: \n  cloud:\n    gateway:\n      discovery:\n        locator:\n          lowerCaseServiceId: true\n          enabled: true\n      routes:\n        # 认证中心\n        - id: mf-oauth\n          uri: lb://mf-oauth\n          predicates:\n            - Path=/oauth2/**\n          filters:\n            - CacheFilter\n            # 验证码处理\n            - CheckCodeFilter\n            - StripPrefix=1\n        # 测试中心\n        - id: mf-test\n          uri: lb://mf-test\n          predicates:\n            - Path=/test/**\n          filters:\n            - StripPrefix=1\n        - id: mf-code\n          uri: lb://mf-code\n          predicates:\n            - Path=/code/**\n          filters:\n            - StripPrefix=1\n        - id: mf-sys\n          uri: lb://mf-sys\n          predicates:\n            - Path=/sys/**\n          filters:\n            - StripPrefix=1\n        - id: mf-storage\n          uri: lb://mf-storage\n          predicates:\n            - Path=/storage/**\n          filters:\n            - StripPrefix=1\n# 安全配置\nsecurity:\n  # 验证码\n  captcha:\n    enabled: true\n    type: math\n    # 网关校验直接返回\n    gatewayCheckCaptcha:\n      # - /oauth2/authorize\n      # 网关校验，自己服务返回\n    selfCheckCaptcha:\n      - /oauth2/authorize?loginType=user_password\n  # 防止XSS攻击\n  xss:\n    enabled: true\n    excludeUrls:\n  # 不校验白名单\n  ignore:\n    whites:\n      - /oauth2/accessToken\n      - /oauth2/authorize\n      - /oauth2/sendMsg\n      - /oauth2/qrCodeLogin/*\n      - /oauth2/img/*\n      - /oauth2/js/*\n      - /oauth2/css/*\n      - /oauth2/fonts/*\n      - /oauth2/static/**\n      - /favicon.ico\n      - /storage/file/*.*\n      - /code/**\n      - /test/**\n      - /*/v2/api-docs', '1159c6b7728a55d00d5397e35baad7e5', '2023-01-11 12:10:11', '2023-01-19 16:02:29', 'nacos', '0:0:0:0:0:0:0:1', '', '', '', '', '', 'yaml', '', '');
