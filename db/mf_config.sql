...
INSERT INTO `config_info` VALUES (2, 'mf-gateway-dev.yml', 'DEFAULT_GROUP', 'spring: \n  cloud:\n    gateway:\n      discovery:\n        locator:\n          lowerCaseServiceId: true\n          enabled: true\n      routes:\n        # 认证中心\n        - id: mf-oauth\n          uri: lb://mf-oauth\n          predicates:\n            - Path=/oauth2/**\n          filters:\n            - CacheFilter\n            # 验证码处理\n            - CheckCodeFilter\n            - StripPrefix=1\n        # 测试中心\n        - id: mf-test\n          uri: lb://mf-test\n          predicates:\n            - Path=/test/**\n          filters:\n            # 验证码处理\n            # - CheckCodeFilter\n            - StripPrefix=1    \n        - id: mf-code\n          uri: lb://mf-code\n          predicates:\n            - Path=/code/**\n          filters:\n            # 验证码处理\n            # - CheckCodeFilter\n            - StripPrefix=1       \n# 安全配置\nsecurity:\n  # 验证码\n  captcha:\n    enabled: true\n    type: math\n    checkUrls:\n      - /oauth2/authorize\n  # 防止XSS攻击\n  xss:\n    enabled: true\n    excludeUrls:\n  # 不校验白名单\n  ignore:\n    whites:\n      - /oauth2/**\n      - /code/**\n      - /ssoUser/**\n      - /*/v2/api-docs', '95a6d9d5bfef85fdc11aea0464d201a8', '2021-11-15 07:59:14', '2022-09-01 09:41:32', 'nacos', '0:0:0:0:0:0:0:1', '', '', '摸鱼网关开发环境配置', '', '', 'yaml', '', '');
...
INSERT INTO `config_info` VALUES (7, 'mf-code-dev.yml', 'DEFAULT_GROUP', 'swagger:\n  title: \'摸鱼代码生成中心\'\ncode:\n  template:\n    keys:\n      - controller\n      - entity\n      - mapper\n      - mapper/xml\n      - req\n      - service\n      - service/impl\n    path: template\n  savePath: D:/mfish\n# mybatis配置\nmybatis-plus:\n  # 配置mapper的扫描，找到所有的mapper.xml映射文件\n  mapper-locations: classpath*:cn/com/mfish/code/mapper/**/*Mapper.xml\n  global-config:\n    # 关闭MP3.0自带的banner\n    banner: false\n    db-config:\n      #主键类型  0:\"数据库ID自增\",1:\"该类型为未设置主键类型\", 2:\"用户输入ID\",3:\"全局唯一ID (数字类型唯一ID)\", 4:\"全局唯一ID UUID\",5:\"字符串全局唯一ID (idWorker 的字符串表示)\";\n      #id-type: 0\n      # 默认数据库表下划线命名\n      table-underline: true\n      #逻辑删除 删除前\n      logic-not-delete-value: 0\n      #逻辑删除 删除后\n      logic-delete-value: 1\n  configuration:\n    # 这个配置会将执行的sql打印出来，在开发或测试的时候可以用\n    #log-impl: org.apache.ibatis.logging.stdout.StdOutImpl\n    # 返回类型为Map,显示null对应的字段\n    call-setters-on-nulls: true\n    map-underscore-to-camel-case: true\n    auto-mapping-behavior: full\n    jdbc-type-for-null:\nspring: \n  datasource:\n    druid:\n      stat-view-servlet:\n        enabled: true\n        loginUsername: admin\n        loginPassword: 123456\n    dynamic:\n      druid:\n        initial-size: 5\n        min-idle: 5\n        maxActive: 20\n        maxWait: 60000\n        timeBetweenEvictionRunsMillis: 60000\n        minEvictableIdleTimeMillis: 300000\n        validationQuery: SELECT 1 FROM DUAL\n        testWhileIdle: true\n        testOnBorrow: false\n        testOnReturn: false\n        poolPreparedStatements: true\n        maxPoolPreparedStatementPerConnectionSize: 20\n        filters: stat,slf4j\n        connectionProperties: druid.stat.mergeSql\\=true;druid.stat.slowSqlMillis\\=5000\n      datasource:\n          # 主库数据源\n          master:\n            driver-class-name: com.mysql.cj.jdbc.Driver\n            url: jdbc:mysql://localhost:3306/mf_oauth?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8\n            username: root\n            password: 123456\n          # 从库数据源\n          # slave:\n            # username: \n            # password: \n            # url: \n            # driver-class-name: \n      # seata: true    # 开启seata代理，开启后默认每个数据源都代理，如果某个不需要代理可单独关闭', '8635238fd1cedea0ee237ceb60f0317d', '2022-08-19 03:52:14', '2022-09-01 07:38:15', 'nacos', '0:0:0:0:0:0:0:1', '', '', '代码生成中心配置', '', '', 'yaml', '', '');
