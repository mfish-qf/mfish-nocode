 ...
 * @description: 认证中心助手
 * <p>
 * 工具自动从ApiToolEngine获取：所有@FeignClient(value=OAUTH_SERVICE)的方法
...
public class OauthAssistant extends BaseAssistant {
    ...
    public OauthAssistant(ChatMemory chatMemory, LlmModelRouter llmModelRouter, ApiToolEngine apiToolEngine) {
