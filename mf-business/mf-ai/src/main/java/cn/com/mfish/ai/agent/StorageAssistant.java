 ...
 * @description: 存储中心助手
 * <p>
 * 工具自动从ApiToolEngine获取：所有@FeignClient(value=STORAGE_SERVICE)的方法
...
public class StorageAssistant extends BaseAssistant {
    ...
    public StorageAssistant(ChatMemory chatMemory, LlmModelRouter llmModelRouter, ApiToolEngine apiToolEngine) {
