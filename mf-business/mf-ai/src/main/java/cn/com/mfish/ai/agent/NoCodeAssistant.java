 ...
 * @description: 低代码中心助手
 * <p>
 * 工具自动从FeignToolRegistry获取：所有@FeignClient(value=NOCODE_SERVICE)的方法
...
public class NoCodeAssistant extends BaseAssistant {
    ...
    public NoCodeAssistant(ChatMemory chatMemory, LlmModelRouter llmModelRouter, FeignToolRegistry feignToolRegistry) {
